...
Field::Field(const XMFLOAT3& pos, const XMFLOAT3& scl, const XMFLOAT4& color, const wchar_t* path)
	:GameObject({pos, { 0.0f,0.0f,0.0f }, scl})
{
	_color = color;
	_path = _wcsdup(path);
}